/// \ingroup vtkWrappers
/// \class ttkComputeGenus
/// \author Your Name Here <Your Email Address Here>
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the computeGenus processing package.
///
/// VTK wrapping code for the @ComputeGenus package.
/// 
...
class VTKFILTERSCORE_EXPORT ttkComputeGenus 
  : public vtkDataSetAlgorithm, public Wrapper{

  public:
    
    static ttkComputeGenus* New();
    vtkTypeMacro(ttkComputeGenus, vtkDataSetAlgorithm)
